...
const Faq = () => {
  const FAQ__DATA = [
    ...
    },
    {
      ...
      answer:
        "The Tornado Cash project does not collect any user data. The UI is hosted in a decentralized way on IPFS and can be accessed using following link tornadocash.eth.link. Users can also run it locally or use the CLI tool.",
    },
    {
      question:
    ...
    {
      question: "Can I prove my source of funds if I use Tornado Cash?",
      answer:
