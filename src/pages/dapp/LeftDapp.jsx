  ...
  return (
    <div className="w-full flex justify-start items-start flex-col">
      <div className="w-full flex justify-between items-center">
        <button className="text-dark font-bold text-lg bg-primary rounded-tl pl-[1.75rem] border-primary border-t border-l border-solid transition-all duration-300 isolate py-[0.68rem] pr-[1.25rem] relative">
          Deposit
        ...
        <button className="text-primary font-bold text-lg bg-darkPrimary rounded-tr pr-[1.75rem] border-primary border-t border-r border-solid transition-all duration-300 isolate py-[0.68rem] pl-[1.25rem] relative">
          Withraw
